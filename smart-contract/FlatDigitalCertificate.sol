...
// File contracts/DigitalCertificate.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.28;
// THÊM DÒNG NÀY
// THÊM ERC721Enumerable VÀO DANH SÁCH KẾ THỪA
contract DigitalCertificate is ERC721, Ownable, ERC721URIStorage, ERC721Enumerable {
    ...
    // Các hàm ghi đè (override) bắt buộc
    function _update(address to, uint256 tokenId, address auth)
        internal
        override(ERC721, ERC721Enumerable) // Thêm ERC721Enumerable
        returns (address)
    {
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ERC721, ERC721URIStorage, ERC721Enumerable) // Thêm ERC721Enumerable
        returns (bool)
    {
